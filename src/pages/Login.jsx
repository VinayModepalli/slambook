...
function Login() {
    return (
        <div className="flex flex-col md:flex-row h-screen p-8 sm:p-0">
            ...
            <div className="md:w-1/2 flex items-center justify-center h-screen sm:p-8">
